...
_UPSTREAM_FAILED = (
    "TRANSPORT_CONTENT_DECODING_FAILED",
    "TRANSPORT_CONTENT_ENCODING_UNSUPPORTED",
...
_RUNTIME_FAILED = (
    "PROVIDER_CONFIG_ENTRY_INVALID",
    "PROVIDER_CONFIG_ENTRY_IS_UPSTREAM",
    "PROVIDER_CONFIG_ENV_KEY_INVALID",
    "PROVIDER_CONFIG_PROVIDER_NOT_REGISTERED",
    "PROVIDER_CONFIG_TOKEN_SOURCE_INVALID",
